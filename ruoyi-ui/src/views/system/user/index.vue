<template>
  <div class="app-container">
    ...
    <!-- 充值金额框 -->
    <el-dialog :title="title" :visible.sync="openRecharge" width="600px" append-to-body :close-on-click-modal="false">
      <el-form ref="forms" :model="forms" :rules="rules" label-width="80px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="充值金额" prop="rechargeAmount">
              <el-input v-model="forms.rechargeAmounts" placeholder="请输入充值金额" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
